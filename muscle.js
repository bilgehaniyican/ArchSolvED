...
function do_insert_result(data, text_row, image_row) {
    text_row.innerHTML = "<td><h3 style='padding: 0.1em'>Solution: " + (data.i + 1).toString() + "</h3></td>" + "<td><h3 style='padding: 0.1em'>Score: " + data.score.toFixed(2) + "</h3></td>" + "<td><button onclick='print_solution(" + data.i + ")'>Print</button></td>" + "<td></td>";
